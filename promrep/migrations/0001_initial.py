...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('interval', models.SmallIntegerField(default=0, choices=[(0, b'on'), (1, b'after'), (2, b'before'), (3, b'by')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True, auto_now_add=True)),
                ('created_by', models.ForeignKey(related_name='postassertiondate_create', verbose_name='author', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('date_type', models.ForeignKey(blank=True, to='promrep.DateType', null=True)),
                ('post_assertion', models.ForeignKey(related_query_name=b'date', related_name='dates', blank=True, to='promrep.PostAssertion', null=True)),
                ('updated_by', models.ForeignKey(related_name='postassertiondate_update', verbose_name='last updated by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True, auto_now_add=True)),
                ('created_by', models.ForeignKey(related_name='postdate_create', verbose_name='author', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('date_type', models.ForeignKey(blank=True, to='promrep.DateType', null=True)),
                ('post', models.ForeignKey(related_query_name=b'date', related_name='dates', blank=True, to='promrep.Post', null=True)),
                ('updated_by', models.ForeignKey(related_name='postdate_update', verbose_name='last updated by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
