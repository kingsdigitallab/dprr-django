...
def processXML(volume):
    ...
    sdict = {
        'mrr1': ['Broughton MRR I', 'promrep/scripts/data/mrr1_all_MR_Officesv23.docx.html.xml'],
        'mrr2': ['Broughton MRR II', 'promrep/scripts/data/mrr2_converted_html_MRv11.xml']
    }
