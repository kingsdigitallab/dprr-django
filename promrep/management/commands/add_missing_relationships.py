...
class Command(BaseCommand):
        ...
        for sib in sibs:
            ...
            if found is not None:
                inverse = RelationshipInverse.objects.get(
                    relationship=relationship, sex=person.sex
                )
    ...
    def reset_assertions(self):
        RelationshipAssertion.objects.filter(
            extra_info="Inferred", is_verified=False
        ).delete()
        RelationshipAssertion.objects.filter(
            extra_info="Inferred Inverse", is_verified=False
        ).delete()
        RelationshipAssertion.objects.filter(
            extra_info="Inferred Inverse 1", is_verified=False
        ).delete()
        RelationshipAssertion.objects.filter(
            extra_info="Inferred Inverse 2", is_verified=False
        ).delete()
        RelationshipAssertion.objects.filter(
            extra_info="Inferred Inverse 3", is_verified=False
        ).delete()
    ...
    def writeassetion(self, new_assert, source_assert):
        ...
        if (
            ...
            inv_type = RelationshipInverse.objects.get(
                relationship=new_assert.relationship, sex=new_assert.related_person.sex
            )
            if (
                RelationshipAssertion.objects.filter(
    ...
    def add_inferred_relationships(self):
        ...
        for person in Person.objects.all():
            ...
            for relassert in RelationshipAssertion.objects.filter(
                ...
                # Mother/Father
                if (
                    relassert.relationship.name == "father of"
                    or relassert.relationship.name == "mother of"
                ):
                    children.append(relassert)
                elif (
                    relassert.relationship.name == "son of"
                    or relassert.relationship.name == "daughter of"
                ):
                    # Son/Daughter
                    ...
                    relassert.relationship.name == "brother of"
                    or relassert.relationship.name == "sister of"
                ):
            ...
            for sib in sibs:
                if (
                    ...
                    and RelationshipAssertion.objects.filter(
                        related_person=sib.related_person, relationship=type_mother
                    ).count()
                    == 0
                ):
                    new_assert = RelationshipAssertion(
                ...
                if (
                    father is not None
                    and RelationshipAssertion.objects.filter(
                        related_person=sib.related_person, relationship=type_father
                    ).count()
                    == 0
                ):
                    new_assert = RelationshipAssertion(
            ...
            if spouse is not None:
                for kid in children:
                    if (
                        spouse.related_person.sex.name == "Male"
                        and RelationshipAssertion.objects.filter(
                        ...
                        new_type = RelationshipInverse.objects.get(
                            relationship__name="father of", sex=kid.related_person.sex
                        )
                        new_assert = RelationshipAssertion(
                            extra_info="Inferred Inverse",
                    ...
                    if (
                        spouse.related_person.sex.name == "Female"
                        and RelationshipAssertion.objects.filter(
                            related_person=kid.related_person,
                        ...
                        new_type = RelationshipInverse.objects.get(
                            relationship__name="mother of", sex=kid.related_person.sex
                        )
                        new_assert = RelationshipAssertion(
                            extra_info="Inferred",
                            related_person=spouse.related_person,
            ...
            for kid in children:
                if kid.related_person.sex.name == "Male":
                    sib_relationship = RelationshipType.objects.get(name="brother of")
                else:
                    sib_relationship = RelationshipType.objects.get(name="sister of")
                for sib in children:
                    if (
                        sib != kid
                        and RelationshipAssertion.objects.filter(
