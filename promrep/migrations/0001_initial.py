    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, verbose_name='created', editable=False)),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, verbose_name='modified', editable=False)),
                ('note_type', models.CharField(max_length=1, choices=[(b'a', b'Assertion'), (b'p', b'AssertionPerson')])),
                ('origin', models.CharField(max_length=1, choices=[(b'r', b'Reference (Body of text)'), (b'e', b'Endnote (Broughton only)')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_notes', models.CharField(help_text=b'Extra notes about the person.', max_length=1024, blank=True)),
